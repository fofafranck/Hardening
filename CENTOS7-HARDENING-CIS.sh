#!/bin/bash
#Description: cis - centos7 hardening  Data Service
#Author: fabrice 
#Date: 09/03/2020
...
rpm --import /etc/pki/rpm-gpg/RPM-GPG-KEY-centos7-release
...
# CIS 4.2.1.2 - 4.2.1.3 Configure /etc/rsyslog.conf
...
# CIS 5.1.2-5.1.7 Change ownership and permission
